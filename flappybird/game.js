...
function check_for_end_game() {
    for (var i = 0; i < pipes.length; i++) if (ImagesTouching(bird, pipes[i])) game_mode = "over";
}
...
function display_game_over() {
    var score = 0;
    for (var i = 0; i < pipes.length; i++) if (pipes[i].x < bird.x) score = score + 0.5;
    ctx.font = "30px Arial";
    ctx.fillStyle = "red";
    ctx.textAlign = "center";
...
function add_all_my_pipes() {
    ...
    add_pipe(3600, 50, 60);
    var finish_line = new MySprite("https://img.bright.games/flappybird/end.png");
    finish_line.x = 3900;
...
pipe_piece.src = "https://img.bright.games/flappybird/pipe.png";
function Do_a_Frame() {
...
bottom_bar.src = "https://img.bright.games/flappybird/ground.png";

var bird = new MySprite("https://img.bright.games/flappybird/flappybird.png");
bird.x = myCanvas.width / 3;
bird.y = myCanvas.height / 2;

setInterval(Do_a_Frame, 1000 / FPS);
//Copyright Bright Games 2020 | https://bright.games/
